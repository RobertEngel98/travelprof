...
export const CMS_DEFAULTS: CmsData = {
  ...
  products_display: {
    ...
    items: [
      ...
      { tag: "Starter", cls: "starter", price: "14 €", name: "Amex Platinum Lohnt-sich-Rechner", desc: "Interaktiver Excel-Rechner: Trage deine Werte ein und sieh, ob sich die Amex Platinum für dich lohnt.", cta: "Sofort freischalten", action: "buy", product_id: "analyse" },
      { tag: "Starter", cls: "starter", price: "19 €", name: "Top 10 Buchungs-Hacks E-Book", desc: "Die 10 besten Buchungsstrategien für günstigere Flüge und bessere Hotels – mit Screenshots.", cta: "Sofort freischalten", action: "buy", product_id: "ebook" },
      { tag: "Kurs", cls: "core", price: "39 €", name: "Meilen-Crashkurs (Video)", desc: "5-Modul Videokurs: Sammeln, Optimieren, Einlösen. Inkl. Kalkulator und Templates.", cta: "Jetzt Zugang sichern", action: "buy", product_id: "crashkurs" },
      { tag: "Kurs", cls: "core", price: "119 €", name: "Meilen-Masterclass", desc: "12 Module, 40+ Videos, Workbooks, Community-Zugang (3 Monate) und ein 1:1 Setup-Call.", cta: "Jetzt Zugang sichern", action: "buy", product_id: "masterclass" },
